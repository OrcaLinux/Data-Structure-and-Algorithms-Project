...
public:
    ...
    void setupUi(QDialog *SearchTopicWindow)
    {
        if (SearchTopicWindow->objectName().isEmpty())
            SearchTopicWindow->setObjectName(QString::fromUtf8("SearchTopicWindow"));
        ...
        topicsCheckBox->setObjectName(QString::fromUtf8("topicsCheckBox"));
        QFont font1;
        ...
        postsCheckBox->setObjectName(QString::fromUtf8("postsCheckBox"));
        QFont font2;
        ...
        postsNoLabel->setObjectName(QString::fromUtf8("postsNoLabel"));
