...
public:
	 ...
	 *
	 */
	explicit HuffmanTreeNode::HuffmanTreeNode()
	 ...
	 */
	HuffmanTreeNode::HuffmanTreeNode(int frequency, char character, HuffmanTreeNode* left, HuffmanTreeNode* right)
	 ...
	 */
	HuffmanTreeNode::HuffmanTreeNode(int frequency, char character)
	 ...
	 */
	bool HuffmanTreeNode::operator<(const HuffmanTreeNode& other) const { return freq > other.freq; }
